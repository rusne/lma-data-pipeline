...
def run(dataframe):
    ...
    transition_agendas = pd.read_csv('Private_data/NACE_Transitieagendas_NL_v1.2.csv', low_memory=False)
    ...
    dataframe.loc[dataframe['Transitieagenda_NACE'].isnull(), 'Transitieagenda_NACE'] = "unknown"
    ...
    transition_agendas = pd.read_csv('Private_data/EURAL_classification_v1.5_NL.csv', low_memory=False)
    ...
    if "GNcode" in dataframe.columns:
        ...
        transition_agendas = pd.read_csv('Private_data/GN_codes_afgiftemeldingen_v1.2.csv', low_memory=False)
        transition_agendas = transition_agendas[['Transitieagenda', 'CN_LMA']]
